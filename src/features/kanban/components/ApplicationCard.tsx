  ...
  return (
    ...
    >
      ...
      {(app.job_location || app.salary_or_hourly_rate) && (
        <div className="flex flex-wrap gap-x-3 gap-y-1 pl-5 text-xs text-muted-foreground">
          {app.job_location && (
      ...
      {app.isGhosted && (
        <div className="ml-5 inline-flex w-fit items-center gap-1 rounded-full bg-warning/15 px-2 py-0.5 text-[11px] font-medium text-warning">
